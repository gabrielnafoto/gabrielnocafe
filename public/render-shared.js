...
(function (root, factory) {
  ...
  const I18N = {
    pt: { buy: "Comprar →", access: "↗ acessar", copyLink: "copiar link", copied: "link copiado", inSetup: "no setup", tried: "testado", setupTitle: "My Setup", setupDesc: "Coisas que realmente fazem parte da minha rotina.", otherTitle: "Other things I like", otherDesc: "Produtos que já testei ou gostei, mas não necessariamente fazem parte do setup atual.", featuredTitle: "coisas que uso todos os dias", videosTitle: "seen in my videos", videosDesc: "algumas das coisas que vocês sempre perguntam nos vídeos.", aboutTitle: "about", navSetup: "setup", navRecipes: "recipes", navFavorites: "favorites", navAbout: "about", soon: "em breve", filterAll: "todos" },
    en: { buy: "Buy →", access: "↗ open", copyLink: "copy link", copied: "link copied", inSetup: "in setup", tried: "tried it", setupTitle: "My Setup", setupDesc: "Things that are really part of my routine.", otherTitle: "Other things I like", otherDesc: "Products I've tried or liked, but that aren't necessarily part of my current setup.", featuredTitle: "things I use every day", videosTitle: "seen in my videos", videosDesc: "some of the things you always ask about in my videos.", aboutTitle: "about", navSetup: "setup", navRecipes: "recipes", navFavorites: "favorites", navAbout: "about", soon: "coming soon", filterAll: "all" },
  };
