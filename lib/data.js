...
const DEFAULT_DATA = {
  profile: {
    ...
    // PLACEHOLDER — stock photography (Pexels), only so a fresh install renders
    // the real contact-sheet cover instead of an empty strip. Swap for your own
    // frames in /admin; anything saved to KV overrides these defaults.
    // Photo: Mohammad Kashkooli on Pexels.
    photo: "https://images.pexels.com/photos/18083118/pexels-photo-18083118.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
    instagram: "https://instagram.com/gabrielnocafe",
    youtube: "",
    twitter: "",
    // Shown in the back-cover colophon. One line per item, "Label: Value" —
    // no photos needed, it's meant to read like a notebook annotation.
    recordingGear: "Câmera: iPhone 15 Pro\nÁudio: microfone de lapela\nEdição: CapCut",
    recordingGear_en: "Camera: iPhone 15 Pro\nAudio: lavalier mic\nEditing: CapCut",
  },
  site: {
    ...
    // Handwritten note at the very end, for whoever scrolled all the way down.
    thanksNote: "ei — obrigado por ter chegado até aqui. valeu o café ☕",
    thanksNote_en: "hey — thanks for scrolling all the way down here. cheers ☕",
  },
  sections: [
    {
      id: "sec_1",
      ...
      items: [
        {
          ...
          // PLACEHOLDER stock photos — Wendy Wei / Mizuno K on Pexels.
          image: "https://images.pexels.com/photos/17567561/pexels-photo-17567561.jpeg?auto=compress&cs=tinysrgb&w=800&q=80",
          gallery: ["https://images.pexels.com/photos/13736083/pexels-photo-13736083.jpeg?auto=compress&cs=tinysrgb&w=800&q=80"],
      ...
      items: [
        {
          ...
          // PLACEHOLDER stock photos — Esra Erdem on Pexels / Lazarescu Alexandra on Unsplash.
          image: "https://images.pexels.com/photos/19723762/pexels-photo-19723762.jpeg?auto=compress&cs=tinysrgb&w=800&q=80",
          gallery: ["https://images.unsplash.com/photo-1620842947093-284677c6c658?auto=format&w=800&q=80&fit=crop"],
          url: "https://example.com",
          affilliate: true,
          dailyUse: true,
          seenInVideos: true,
    ...
    },
    {
      ...
      items: [
        {
          id: "item_3", label: "diário de shots", label_en: "shot diary",
          name: "Notion", name_en: "Notion",
          url: "https://notion.so", affilliate: false,
          description: "Onde eu anoto ideia de vídeo, roteiro e receita de café.",
          description_en: "Where I jot down video ideas, scripts and coffee recipes.",
          // PLACEHOLDER stock photo — Anna Tarazevich on Pexels.
          image: "https://images.pexels.com/photos/4927238/pexels-photo-4927238.jpeg?auto=compress&cs=tinysrgb&w=800&q=80",
        },
      ],
    },
    {
